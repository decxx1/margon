...
<template>
    <div 
        class="w-72 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-4 my-4"
    >
        ...
        <div class="p-5">
            <a href="#">
                <h5 class="mb-3 text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">{{ title }}</h5>
            </a>
            ...
            <p v-if="dose" class="mb-3 mt-2 font-normal text-gray-700 dark:text-gray-400"><span class="font-bold text-sm">Peso: </span>{{ dose }}</p>
